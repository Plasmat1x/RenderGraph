...
public static class CommandExtensions
{
  ...
  /// </summary>
  public static bool IsStateCommand(this ICommand _command) => _command.Type switch
  {
  ...
  /// </summary>
  public static bool IsDrawCommand(this ICommand _command) => _command.Type switch
  {
  ...
  /// </summary>
  public static bool IsComputeCommand(this ICommand _command)
  {
  ...
  /// </summary>
  public static bool IsCopyCommand(this ICommand _command)
  {
    return _command.Type switch
    {
  ...
  /// </summary>
  public static CommandCategory GetCommandCategory(this ICommand _command)
  {
    if(_command.IsStateCommand())
      return CommandCategory.State;
    if(_command.IsDrawCommand())
      return CommandCategory.Draw;
    if(_command.IsComputeCommand())
      return CommandCategory.Compute;
    if(_command.IsCopyCommand())
      return CommandCategory.Copy;

    return _command.Type switch
    {
      CommandType.ClearRenderTarget or
      CommandType.ClearDepthStencil or
      CommandType.ClearUnorderedAccess => CommandCategory.Clear,

      CommandType.TransitionResource or
      CommandType.TransitionResources or
      CommandType.UAVBarrier or
      CommandType.UAVBarriers => CommandCategory.Synchronization,

      CommandType.BeginQuery or
      CommandType.EndQuery => CommandCategory.Query,

      CommandType.PushDebugGroup or
      CommandType.PopDebugGroup or
