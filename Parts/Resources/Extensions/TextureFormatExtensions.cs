...
public static class TextureFormatExtensions
{
  ...
  /// </summary>
  public static uint GetFormatSize(this TextureFormat _format) => _format switch
  {
    // 32-bit formats
  ...
  /// </summary>
  public static bool IsCompressed(this TextureFormat _format) => _format switch
  {
    TextureFormat.BC1_TYPELESS or
    TextureFormat.BC1_UNORM or
    TextureFormat.BC1_UNORM_SRGB or
  ...
  /// </summary>
  public static bool IsDepthStencil(this TextureFormat _format) => _format switch
  {
  ...
  /// </summary>
  public static bool IsSRGB(this TextureFormat _format) => _format switch
  {
    TextureFormat.R8G8B8A8_UNORM_SRGB or
    TextureFormat.BC1_UNORM_SRGB or
    TextureFormat.BC2_UNORM_SRGB or
  ...
  /// </summary>
  public static TextureFormat GetTypelessFormat(this TextureFormat _format)
  {
