...
/// </summary>
public class DX12ShaderCache
{
  private readonly string p_cacheDirectory;
  private readonly Dictionary<string, DX12CachedShaderInfo> p_cache = new();

  public DX12ShaderCache(string _cacheDir = "ShaderCache")
  {
  ...
  public void CacheShader(ShaderDescription _description, byte[] _bytecode)
  {
    ...
    p_cache[hash] = new DX12CachedShaderInfo
    {
      Hash = hash,
