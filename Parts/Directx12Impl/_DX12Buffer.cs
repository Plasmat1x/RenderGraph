...
//public unsafe class _DX12Buffer : IBuffer
//{
//  private readonly ComPtr<ID3D12Device> p_device;
//  private readonly D3D12 p_d3d12;
//  private readonly Dictionary<BufferViewType, _DX12BufferView> p_views = [];
//  private readonly _BufferDescription p_description;
...
//  public _BufferDescription Description => p_description;
...
//  {
//    var desc = new _BufferViewDescription
//    {
//      Offset = 0,
...
//  public IBufferView CreateView(_BufferViewDescription _description)
//  {
//    ThrowIfDisposed();
...
//  {
//    if(p_disposed)
//      throw new ObjectDisposedException(nameof(_DX12Buffer));
//  }
...
//  private _DX12BufferView CreateViewInternal(BufferViewType _viewType, _BufferViewDescription _description)
//  {
...
//        return new _DX12BufferView(this, _viewType, _description, null);
...
//    return new _DX12BufferView(this, _viewType, _description, allocation);
//  }
//}
