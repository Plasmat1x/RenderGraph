...
public unsafe class DX12RootSignatureDescBuilderEx : IDisposable
{
  ...
  public DX12RootSignatureDescBuilderEx AllowInputAssemblerInputLayout()
  {
    p_flags |= RootSignatureFlags.AllowInputAssemblerInputLayout;
    return this;
  }

  public DX12RootSignatureDescBuilderEx AllowStreamOutput()
  {
    p_flags |= RootSignatureFlags.AllowStreamOutput;
    return this;
  }

  public DX12RootSignatureDescBuilderEx AddRootCBV(
  ...
  public DX12RootSignatureDescBuilderEx AddRoot32BitConstants(
  ...
  public DX12RootSignatureDescBuilderEx AddDescriptorTableSRV(
    uint _baseRegister,
  ...
  public DX12RootSignatureDescBuilderEx AddDescriptorTableUAV(
    uint _baseRegister,
    uint _descriptorCount,
    uint _registerSpace = 0,
    ShaderVisibility _visibility = ShaderVisibility.All)
  ...
  public DX12RootSignatureDescBuilderEx AddDescriptorTableSamplers(
    uint _baseRegister,
    uint _descriptorCount,
    uint _registerSpace = 0,
    ShaderVisibility _visibility = ShaderVisibility.Pixel)
  ...
  public DX12RootSignatureDescBuilderEx AddDescriptorTable(
  ...
  public DX12RootSignatureDescBuilderEx AddStaticSampler(
    uint _shaderRegister,
