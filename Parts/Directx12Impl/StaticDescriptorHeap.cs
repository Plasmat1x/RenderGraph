...
public unsafe class StaticDescriptorHeap: IDisposable
{
  ...
  public DescriptorAllocation Allocate(uint _count = 1)
  {
    ...
    {
      var allocation = new DescriptorAllocation(
        this, 
        p_currentIndex, 
        _count, 
        p_descriptorSize, 
